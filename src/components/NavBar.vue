<template>
  ...
  <v-card class="nav-wrapper blue lighten-4" ref="navbar" :class="{ bgColor: active }" elevation="10">
    <v-row class="nav-transparent mx-2 pl-12" justify="space-between" align="center">
      ...
      <!-- 头像和昵称 ，点击也是动态路由跳转-->
      <v-col cols="12" md="2">
        <router-link :to="'/layout/my/' + loginUser.id" link>
          <v-avatar>
            <v-img :src="loginUser.avatar"></v-img>
          </v-avatar>
